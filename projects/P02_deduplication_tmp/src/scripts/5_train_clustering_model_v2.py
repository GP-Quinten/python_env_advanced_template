...
def main():
    ...
    # Save results
    results_df.to_excel(
        "data/5_clustering_perf/train_clustering_model_results_v5_all.xlsx", index=False
    )

    # Create and save the figure
    fig = create_figure(results_df)
    fig.write_html("data/5_clustering_perf/clustering_performance_metrics_v5_all.html")
